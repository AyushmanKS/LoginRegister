                                    ...
                                    child: Container(
                                      ...
                                      child: const Row(
                                        ...
                                        children: [
                                          Text(
                                            'Register',
                                            style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500,color: Color(0xFF6a7b8c)),
                                          ),
                                        ],
                                      ),
                                    ),
                          ...
                          const Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text('Or login with',style: TextStyle(color: Color(0xFF6a7b8c)),),
                              ),
                              Expanded(child: Divider()),
                            ],
                          ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Image.asset(
                                        ...
                                        height: 30, // Adjust image size if needed
                                      ),
                                      const SizedBox(width: 10),
                                      const Text(
                                        'Google',
                                        style: TextStyle(fontSize: 16,color: Color(0xFF6a7b8c)),
                                      ),
                                    ],
                                  ),
                                ),
